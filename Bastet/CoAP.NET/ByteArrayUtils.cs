    ...
    static class ByteArrayUtils
    {
        ...
        public static Byte[] FromHexStream(String hex)
        {
            try
            {
                ...
                {
                    Int16 high = Int16.Parse(hex[i].ToString(), NumberStyles.HexNumber, CultureInfo.InvariantCulture);
                    Int16 low = Int16.Parse(hex[i + 1].ToString(), NumberStyles.HexNumber, CultureInfo.InvariantCulture);
